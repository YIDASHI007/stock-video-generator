...
import {Archive, Edit3, Film, Grid2X2, Heart, List, Play, Search, Send, Tag, X} from "lucide-react";
import {Link} from "react-router-dom";

import {api, coverUrl, thumbnailUrl, videoUrl, type GalleryOutput} from "../api";
  ...
  return (
    <div className="page content-library-page">
      ...
      <section className="asset-toolbar">
        ...
        <span className="asset-count">{outputs.length} 条内容</span>
      ...
      <section className={`asset-collection ${view}`}>
        ...
        {outputs.length === 0 ? <div className="asset-empty"><Film size={28}/><strong>没有符合筛选条件的内容</strong><span>更换筛选条件，或先运行一个内容工作流。</span></div> : null}
      </section>
